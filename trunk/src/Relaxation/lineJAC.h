 ...
 */
	...
	class lineJAC : public mg::Relaxation
	{
	    ...
	    public:
             ...
             */ 
	        lineJAC(const int nreld =1,const int nrelu =1, const precision omega =1.0,const int direction =0) : nreld_(nreld), nrelu_(nrelu), omega_(omega), direction_(direction) {}
            virtual ~lineJAC() {}
