 ...
 * \f]
 */
class Laplacian2D2 : public mg::Stencil
{
private:
	...
	Laplacian2D2& operator=(const Laplacian2D2& rhs);
public:
	/**
	 ...
	 */
	explicit Laplacian2D2(precision a_x =1.0,precision a_y =1.0) : L(5), J_x(init_J_x()), J_y(init_J_y()), ax(a_x), ay(a_y) {}
