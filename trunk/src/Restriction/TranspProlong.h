/** \file TranspProlong.h
 * \author <a href="mailto:mail@jirikraus.de">Jiri Kraus</a>
 * \brief Contains the interface of the class TranspProlong.
 */
...
/**
 * \brief TranspProlong is a 2D restriction operator
 * 
 * TranspProlong is a representation of a 2D restriction operator that uses
 * an associated prolongation operator to do its job.
 */
class TranspProlong : public mg::Restriction
{
private:
	...
	TranspProlong(const TranspProlong& rhs);
	TranspProlong& operator=(const TranspProlong& rhs);
public:
	/**
	 * \brief The constructor of a TranspProlong object
	 * 
	 * TranspProlong constructs a TranspProlong object with:
	 * \param[in] weight	the weight to do full weighting with (default 1.0)
	 */
	
	TranspProlong(const Prolongation& prolongation, Precision weight = 1.0): weight_(weight), prolongation_(prolongation) {};
	virtual ~TranspProlong(){}
