/** \file SevenPointRestriction.h
 * \author Mareike Riepl, Michaela Anghel, Daniela Steffes-Lai
 * \brief Contains the interface of the class SevenPointRestriction
 * \see Restriction.h
 */
#ifndef SEVENPOINTRESTRICTION_H_
#define SEVENPOINTRESTRICTION_H_
...
/**
 * \brief SevenPointRestriction is a 2D restriction operator
 * 
 * SevenPointRestriction is a representation of a 2D restriction operator that
 * uses seven point restriction to do its job.
 */
class SevenPointRestriction : public mg::Restriction
{
private:
    ...
    SevenPointRestriction(const SevenPointRestriction& rhs);
    SevenPointRestriction& operator=(const SevenPointRestriction& rhs);
public:
    /**
     * \brief The constructor of a SevenPointRestriction object
     * 
     * SevenPointRestriction constructs a SevenPointRestriction object with:
     * \param[in] weight    the weight to do the restriction with (default 1.0)
     */
    SevenPointRestriction(Precision weight=1.0)
        : weight_(weight),
          i_(initI_(weight)), 
          jx_(initJX_()), jy_(initJY_()) {}
          
    virtual ~SevenPointRestriction(){}
...
#endif /*SEVENPOINTRESTRICTION_H_*/
